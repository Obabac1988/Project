                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade in show active" id="panel7" role="tabpanel">
                        ...
                        <div id="login" class="modal-body mb-1">
                            <form method="post" action="/festival/login" class="form-group form-mine">
...
//                        echo $test;
//                        $test = Request::factory('festival/test2')->execute();

//                        echo Debug::vars($test);
                            echo preg_replace("~Home -~", "", $title[0]);
                        ?>
                    </h3>
                    <dl>
                        <dt>
                ...
                <div class="col-md-4">
                    <img width="100%" alt="Bootstrap Image Preview" src="<?= $image[0] ?>"/>
                </div>
            </div>
            <div class="row">
                <div class="col-md-4">
