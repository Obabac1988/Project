...
class Kohana_URLTest extends Unittest_TestCase
{
	...
	protected $environmentDefault =	array(
		...
		'Kohana::$index_file'=> 'festivalList.php',
	...
	public function provider_base()
	{
		return array(
			...
			array(NULL,    TRUE,  '/kohana/festivalList.php/'),
			array(NULL,    TRUE,  '/kohana/festivalList.php/'),
			array('http',  TRUE,  'http://example.com/kohana/festivalList.php/'),
			array('https', TRUE,  'https://example.com/kohana/festivalList.php/'),
			array('ftp',   TRUE,  'ftp://example.com/kohana/festivalList.php/'),

			// Test for automatic protocol detection, protocol = TRUE
			array(TRUE,    TRUE,  'cli://example.com/kohana/festivalList.php/', array('HTTPS' => FALSE, 'Request::$initial' => Request::factory('/')->protocol('cli'))),
	...
	{
		return array(
			array('', NULL,		'/kohana/festivalList.php/'),
			array('', 'http',			'http://example.com/kohana/festivalList.php/'),

			array('my/site', NULL, '/kohana/festivalList.php/my/site'),
			array('my/site', 'http',  'http://example.com/kohana/festivalList.php/my/site'),

			// @ticket #3110
			array('my/site/page:5', NULL, '/kohana/festivalList.php/my/site/page:5'),
			array('my/site/page:5', 'http', 'http://example.com/kohana/festivalList.php/my/site/page:5'),

			array('my/site?var=asd&kohana=awesome', NULL,  '/kohana/festivalList.php/my/site?var=asd&kohana=awesome'),
			array('my/site?var=asd&kohana=awesome', 'http',  'http://example.com/kohana/festivalList.php/my/site?var=asd&kohana=awesome'),

			array('?kohana=awesome&life=good', NULL, '/kohana/festivalList.php/?kohana=awesome&life=good'),
			array('?kohana=awesome&life=good', 'http', 'http://example.com/kohana/festivalList.php/?kohana=awesome&life=good'),

			array('?kohana=awesome&life=good#fact', NULL, '/kohana/festivalList.php/?kohana=awesome&life=good#fact'),
			array('?kohana=awesome&life=good#fact', 'http', 'http://example.com/kohana/festivalList.php/?kohana=awesome&life=good#fact'),

			array('some/long/route/goes/here?kohana=awesome&life=good#fact', NULL, '/kohana/festivalList.php/some/long/route/goes/here?kohana=awesome&life=good#fact'),
			array('some/long/route/goes/here?kohana=awesome&life=good#fact', 'http', 'http://example.com/kohana/festivalList.php/some/long/route/goes/here?kohana=awesome&life=good#fact'),

			array('/route/goes/here?kohana=awesome&life=good#fact', 'https', 'https://example.com/kohana/festivalList.php/route/goes/here?kohana=awesome&life=good#fact'),
			array('/route/goes/here?kohana=awesome&life=good#fact', 'ftp', 'ftp://example.com/kohana/festivalList.php/route/goes/here?kohana=awesome&life=good#fact'),
		);
	}
	...
	public function provider_site_url_encode_uri()
	{
		...
		foreach ($provider as $i => $params)
		{
			...
			$provider[$i] = array("/kohana/festivalList.php/{$expected}", $uri);
		}
