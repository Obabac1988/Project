...
class Kohana_HTMLTest extends Unittest_TestCase
{
	...
	public function provider_script()
	{
		return array(
			...
			array(
				'<script type="text/javascript" src="http://www.kohanaframework.org/kohana/festivalList.php/my/script.js"></script>',
				'my/script.js',
				NULL,
				'http',
				TRUE
	...
	public function provider_style()
	{
		return array(
			...
			array(
				'<link type="text/css" href="https://www.kohanaframework.org/kohana/festivalList.php/my/style.css" rel="stylesheet" />',
				'my/style.css',
				array(),
				'https',
				TRUE
			...
			array(
				...
				'<link type="text/css" href="https://www.kohanaframework.org/kohana/festivalList.php/my/style.css" rel="stylesheet/less" />',
				'my/style.css',
				array(
					'rel' => 'stylesheet/less'
				),
	...
	public function provider_anchor()
	{
		return array(
			...
			array(
				'<a href="https://www.kohanaframework.org/kohana/festivalList.php/users/example">Kohana</a>',
				array(),
				'users/example',
				'Kohana',
				NULL,
	...
	public function provider_file_anchor()
	{
		return array(
			...
			array(
				'<a href="https://www.kohanaframework.org/kohana/festivalList.php/mypic.png" attr="value">My picture file</a>',
				array('attr' => 'value'),
				'mypic.png',
				'My picture file',
				'https',
